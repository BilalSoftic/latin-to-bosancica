...
const FontStyle = () => {
  ...
  return (
    <div className='fontWrapper  flex flex-col  row-start-2 md:row-start-1 md:row-span-2 font-bold md:bg-background  md:border-black px-3 md:p-4 lg:p-6 md:border-4 rounded-custom-radius'>
      <div className=' flex flex-row mb-2 lg:mb-6'>
        <h4 className='text-xl md:text-2xl lg:text-4xl capitalize w-[10rem]  lg:w-[15rem] mr-6'>
          font style
        </h4>
